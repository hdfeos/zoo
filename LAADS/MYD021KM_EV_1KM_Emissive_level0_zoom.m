...
cbar_handle=colorbar('YTick', min(min(data)):data_range/10.0:max(max(data)));
...
if ishghandle(figure_handle)
  ...
  'MYD021KM.A2002226.0000.005.2009193222735_EV_1KM_Emissive_Band_1KM_Emissive0_zoom.m.jpg');
end
