...
This example code illustrates how to access and visualize a LAADS VNP14IMG
v2 netCDF-4/HDF5 Swath file in Python.
...
Usage: save this script and run
  ...
  $python VNP14IMG.A2018064.1200.002.2024079084304.nc.py

The netCDF-4/HDF5 file must be in your current working directory.
...
with h5py.File(FILE_NAME, mode="r") as f:
    ...
    # Read attributes.
    units = f[name].attrs["units"][0].decode()
    long_name = f[name].attrs["long_name"][0].decode()
