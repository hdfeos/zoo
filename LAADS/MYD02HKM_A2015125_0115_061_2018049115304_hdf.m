%
% This example code illustrates how to access and visualize LAADS MYD02HKM v6.1
...
% 
% $matlab -nosplash -nodesktop -r MYD02HKM_A2015125_0115_061_2018049115304_hdf
%
...
% Open file.
FILE_NAME='MYD02HKM.A2015125.0115.061.2018049115304.hdf';
...
% Subset 3-D data and make 2D.
lev=0;
data=squeeze(data_raw(:,:,lev+1));


% Read lat/lon info from the outputs of  eo2dump file.
lat1D = ...
    load('lat_MYD02HKM.A2015125.0115.061.2018049115304.output');

lon1D = ...
    load('lon_MYD02HKM.A2015125.0115.061.2018049115304.output');
...
scatterm(lat(1:5:end), lon(1:5:end), 1, data(1:5:end));
...
dname = field_info.Swath.DataFields(3).Dims(1).Name;
title({FILE_NAME; ...
      ['Reflectance derived from ',long_name ]; ...
      ['at ', strrep(dname,'_','\_'),'=',int2str(lev)]}, ...
