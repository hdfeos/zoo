...
Usage:  save this script and run
   ...
   $python MOD06_L2.A2010001.0000.061.2017308133515.hdf.py
...
# pcolormesh() will generate a warning.
# m.pcolormesh(longitude, latitude, data, latlon=True)
m.scatter(longitude, latitude, c=data, s=1, latlon=True)
cb = m.colorbar()
...
plt.title(
    "{0}\n{1}\n{2}\n{3}".format(
        basename, long_name[0:81], long_name[81:158], long_name[158:]
    ),
    fontsize=8,
)
