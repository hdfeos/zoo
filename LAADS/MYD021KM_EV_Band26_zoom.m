...
% get the HDF-EOS file/field info
...
% Replacing the filled value with IEEE NaN
data(data==fillvalue) = NaN;
% Replacing values outside of valid_range with IEEE NaN
...
figure_handle=figure('Name', ...
    'MYD021KM.A2002226.0000.005.2009193222735_EV_Band26', 'visible','on');
% if 'visible'->'on', figure_handle may be undefined

whitebg('w');
% Set the plotting parameters -- lat/lon limits 'zoom' the plot
...
if ishghandle(figure_handle)
  ...
  'MYD021KM.A2002226.0000.005.2009193222735_EV_Band26_zoom.m.jpg');
end
