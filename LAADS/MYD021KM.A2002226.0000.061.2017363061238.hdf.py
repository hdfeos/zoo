"""
This example code illustrates how to access and visualize a LAADS MYD021KM v6.1
...
Usage:  save this script and run
  ...
  $python MYD021KM.A2002226.0000.061.2017363061238.hdf.py
...
plt.title(
    "{0}\n{1}\nat {2}=0".format(
        basename, "Radiance derived from " + long_name, dimname
    ),
    fontsize=10,
)
fig = plt.gcf()
