...
%                                   
%
% $matlab -nosplash -nodesktop -r GPM_2
%
...
% Open the HDF5 File.
FILE_NAME = '2A.GPM.GMI.GPROF2014v1-4.20150331-S232954-E010226.006182.V03D.HDF5';
file_id = H5F.open (FILE_NAME, 'H5F_ACC_RDONLY', 'H5P_DEFAULT');

% Open the dataset.
DATAFIELD_NAME = 'S1/surfacePrecipitation';
...
% The fill value attribute says -9999.900391 but data uses -9999.0.
fillvalue = -9999.0;                                  
