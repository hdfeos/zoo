...
#
# $Rscript AIRS.2003.02.05.L3.RetStd_H001.v6.0.12.0.G14112124328.hdf.r
#
...
# Open file.
fname = 'AIRS.2003.02.05.L3.RetStd_H001.v6.0.12.0.G14112124328.hdf'
nc <- nc_open(fname)

# Select dataset to plot.
v1 <- nc$var[['Temperature_MW_A']]
z_all <- ncvar_get(nc, 'Temperature_MW_A')
...
# Set color palette.
clevs<-c(220,230,240,250,260,270,280,290,300,310,320,330)
...
title(fname, sub='Temperature_MW_A at TempPrsLvls=0')
dev.off()
nc_close(nc)