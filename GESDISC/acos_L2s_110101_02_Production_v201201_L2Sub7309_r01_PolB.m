...
%
% $matlab -nosplash -nodesktop -r acos_L2s_110101_02_Production_v201201_L2Sub7309_r01_PolB
% 
...
TIMEFIELD_NAME='RetrievalHeader/sounding_time_tai93';
...
% "README Document for ACOS Level 2 Standard Product" [2].
...
textm(latitude(1), lon(1), '+', 'FontSize', 10, 'FontWeight','bold', ...
      'Color', 'red');
...
% [2] https://oco.jpl.nasa.gov/files/oco/README.ACOS_L2S_v2.8.pdf
