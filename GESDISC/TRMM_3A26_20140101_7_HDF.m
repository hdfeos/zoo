...
% TRMM 3A26 v7. HDF4 Grid in MATLAB. 
%
...
%                                   
% $matlab -nosplash -nodesktop -r TRMM_3A26_20140101_7_HDF
%
...
lat = -49.875 : 5.0 : 49.875;
lon = -179.875 : 5.0 : 179.875;
...
surfm(lat,lon,data(:,:,1));
colormap('Jet');
h=colorbar();
plotm(coast.lat,coast.long,'k');
tightmap;

title({FILE_NAME; [DATAFIELD_NAME, ' at nh3=0']}, ...
      'Interpreter', 'None');
