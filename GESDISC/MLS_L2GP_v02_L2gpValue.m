...
%
% >matlab -nosplash -nodesktop -r MLS_L2GP_v02_L2gpValue
%
% Please note that there is no .m in the above command at the end.
% If X-Window conneciton is active, set DISPLAY environment
% variable to0 first.
clear
...
saveas(f, 'MLS-Aura_L2GP-BrO_v02-23-c01_2010d255_L2gpValue_line.m.jpg');
exit;
