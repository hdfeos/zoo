...
% Plot the data using contourfm and axesm
  ...
  f=figure('Name','3B43.070901.6A_precipitation_scale0','visible','off')
  ...
  colormap('Jet');
  caxis([min_data max(max(data))]); 
  h=colorbar('YTick', min_data:0.1:max(max(data)));
  ...
  saveas(f,'3B43.070901.6A_precipitation_scale0.m.jpg');