...
% LP DAAC MCD43D59 v6 HDF-EOS2 Grid file using MATLAB.
%
...
% 
% $matlab -nosplash -nodesktop -r MCD43D59_A2018116_006_2018125060746_hdf
%
...
FILE_NAME='MCD43D59.A2018116.006.2018125060746.hdf';
GRID_NAME='MCD_CMG_BRDF_30Arc Second';
DATAFIELD_NAME='BRDF_Albedo_WSA_VIS';
...
% Select every 10th point to avoid out of memory error.
data=double(data(1:10:end, 1:10:end));
lon=double(lon_value(1:10:end));
lat=double(lat_value(1:10:end));
