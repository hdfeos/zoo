...
% TERRA 13A2 Sinusoidal Grid file in MATLAB. 
%
...
%
% $matlab -nosplash -nodesktop -r MOD13A2_A2000049_h25v03_005_2006270040826_hdf
%
...
FILE_NAME='MOD13A2.A2000049.h25v03.005.2006270040826.hdf';
...
DATAFIELD_NAME='1 km 16 days EVI';
...
%
% eos2dump -c1 MOD13A2.A2000049.h25v03.005.2006270040826.hdf  > lat_MOD13A2.A2000049.h25v03.005.2006270040826.output
% eos2dump -c2 MOD13A2.A2000049.h25v03.005.2006270040826.hdf  > lon_MOD13A2.A2000049.h25v03.005.2006270040826.output
% To properly display the data, the latitude/longitude must be remapped.
% For information on how to obtain the lat/lon data, check [1].

lat1D = load('lat_MOD13A2.A2000049.h25v03.005.2006270040826.output');
lon1D = load('lon_MOD13A2.A2000049.h25v03.005.2006270040826.output');
