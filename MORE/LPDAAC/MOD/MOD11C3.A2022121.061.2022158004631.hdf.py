"""
This example code illustrates how to access and visualize an LP DAAC MOD11C3
v6.1 HDF-EOS2 Grid file in Python.
...
Usage:  save this script and run
    ...
    $python MOD11C3.A2022121.061.2022158004631.hdf.py
...
FILE_NAME = 'MOD11C3.A2022121.061.2022158004631.hdf'
