...
Aqua HDF4 Grid files and calculate monthly average over some region in Python.
...
Usage:  save this script and run
    ...
    $python CER_ES4_Aqua-Xtrk_Edition4_403409.2022.hdf.m.py
...
FILE_NAME = "CER_ES4_Aqua-Xtrk_Edition4_403409.2022*.hdf"
...
# Save the plot.
pngfile = FILE_NAME.replace("*", "") + ".m.py.png"
fig = pl.get_figure()
fig.savefig(pngfile)
