...
%
%  $matlab -nosplash -nodesktop -r CER_ES4_Aqua_Xtrk_Edition4_403409_202201_hdf_h
%
...
VG2_NAME = 'Monthly Hourly Averages';
VG3_NAME = 'Total-Sky';
...
for k =1:d(3)
  ...
  data_s = data_h(s);
  writematrix(horzcat(k-1, mean(data_s(:), "omitmissing")), 'out_h.csv', ...
              'WriteMode','append');    
end
 

% Read filtered data to calculate average.
A = readtable('out_h.csv');
