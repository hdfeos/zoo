...
figure('Name','MOP03-20000303-L3V1.0.1_CO_Profiles_Day_nprs0')
...
colorbar('YTick', min_data:40:max_data);

plotm(coast.lat,coast.long,'k')

title({'MOP03-20000303-L3V1.0.1\_CO\_Profiles\_Day' ; 'at nprs=0'},'FontSize',16,'FontWeight','bold');
