...
This example code illustrates how to access, subset, and visualize a LaRC 
CALIPSO L2 HDF4 file in Python.
...
Usage:  save this script and run
    ...
    $python CAL_LID_L2_05kmALay-Standard-V4-20.2020-06-30T20-55-17ZN.hdf.s.py
...
mask = ((lat0 > latbounds[0]) & (lat0 < latbounds[1]) &
        (lon0 > lonbounds[0]) & (lon0 < lonbounds[1]))
lat = lat0[mask]
lon = lon0[mask]
data = data0[mask]
