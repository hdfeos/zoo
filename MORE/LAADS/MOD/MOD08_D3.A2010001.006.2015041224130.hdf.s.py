...
HDF-EOS2 Grid file in Python. This code subsets data for a specific region.
...
Usage:  save this script and run
    ...
    $python MOD08_D3.A2010001.006.2015041224130.hdf.s.py
...
# Subset data / lat / lon.
datas = datam[latui:latli , lonli:lonui ]
lons = lon[lonli:lonui]
lats = lat[latui:latli]

# Use Geographic projection.
ax = plt.axes(projection=ccrs.PlateCarree())

# Plot on map.
p = plt.pcolormesh(lons, lats, datas, transform=ccrs.PlateCarree())
