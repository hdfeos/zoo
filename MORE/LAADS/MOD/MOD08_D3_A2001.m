...
%
% $matlab -nosplash -nodesktop -r MOD08_D3_A2001
%
...
for k = 1:numel(D)
    ...
    writematrix(horzcat(time, mean(data(:), "omitmissing")), 'out.csv', ...
                'WriteMode','append');
end
...
B = varfun(@mean, A, 'InputVariables', 2,...
           'GroupingVariables', 1);
% Draw plot.
f = figure('Name', 'MOD08_D3 Daily Average', 'visible', 'off');
...
% Put title.
tstring = {'MOD08_D3 Daily Average [0~30N] & [20~60E]';DATAFIELD_NAME};
