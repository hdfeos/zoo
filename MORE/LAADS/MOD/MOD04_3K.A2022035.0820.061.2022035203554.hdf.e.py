...
This example code illustrates how to access a LAADS MOD04_3K Swath
file in Python.
...
Usage:  save this script and run
    ...
    $python MOD04_3K.A2022035.0820.061.2022035203554.hdf.e.py
...
# Save image.
pngfile = "{0}.e.py.png".format(basename)
fig.savefig(pngfile)
