...
% monthly average of multiple LAADS MODIS MOD04_3K L2 swath files in MATLAB. 
%
...
%
% $matlab -nosplash -nodesktop -r MOD04_3K_A2022_m
%
...
for k =1:numel(D)
    ...
    str_mo = datestr(datevec(datenum(2022, 1, day)), 'mm');
    time(:) = str2double(str_mo);
...
xtickformat('%d');
xticks(B.Var1);
xlabel('Month in 2022');

% Put title.
tstring = {'MOD04_3K Monthly Average at lon=40E lat=10N';DATAFIELD_NAME};
...
saveas(f, ['MOD04_3K_A2022_m.m.png']);
exit;
