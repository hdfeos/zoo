...
figure('Name','MODARNSS.Abracos_Hill.A2000080.1515.005.2007164153544_EV_1KM_Emissive_Band_1KM_Emissive5')
...
colorbar('YTick', min(min(data)):0.05:max(max(data)));

plotm(coast.lat,coast.long,'k')

title({'MODARNSS.Abracos\_Hill.A2000080.1515.005.2007164153544\_EV\_1KM\_Emissive' ; ['at Band\_1KM\_Emissive=5, units: ',units]}, 'FontSize',16,'FontWeight','bold');