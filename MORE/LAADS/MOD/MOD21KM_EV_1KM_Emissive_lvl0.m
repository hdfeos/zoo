...
figure('Name','MOD021KM.A2000055.0000.005.2010041143816_EV_1KM_Emissive_Band_1KM_Emissive0')
...
colorbar('YTick', min(min(data)):0.002:max(max(data)));

plotm(coast.lat,coast.long,'k')

title({'MOD021KM.A2000055.0000.005.2010041143816\_EV\_1KM\_Emissive' ; ['at Band\_1KM\_Emissive=0, units: ',units]}, 'FontSize',16,'FontWeight','bold');