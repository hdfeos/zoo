...
Usage:  save this script and run
    ...
    $python SMAP_L4_SM_lmc_00000000T000000_Vv7031_001.h5.py
...
FILE_NAME = "SMAP_L4_SM_lmc_00000000T000000_Vv7031_001.h5"

with h5py.File(FILE_NAME, mode="r") as f:

    name = "/Land-Model-Constants_Data/cell_elevation"
    data = f[name][:]
