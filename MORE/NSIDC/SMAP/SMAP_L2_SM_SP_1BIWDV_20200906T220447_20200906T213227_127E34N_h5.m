...
%                                   
%
%   $matlab -nosplash -nodesktop -r SMAP_L2_SM_SP_1BIWDV_20200906T220447_20200906T213227_127E34N_h5
%
% Tested under: MATLAB R2020a
% Last updated: 2020-09-18

% Open the HDF5 File.
FILE_NAME = 'SMAP_L2_SM_SP_1BIWDV_20200906T220447_20200906T213227_127E34N_R17000_001.h5';
file_id = H5F.open (FILE_NAME, 'H5F_ACC_RDONLY', 'H5P_DEFAULT');

% Open the dataset.
DATAFIELD_NAME = 'Soil_Moisture_Retrieval_Data_1km/soil_moisture_1km';
data_id = H5D.open (file_id, DATAFIELD_NAME);

Lat_NAME='Soil_Moisture_Retrieval_Data_1km/latitude_1km';
lat_id=H5D.open(file_id, Lat_NAME);

Lon_NAME='Soil_Moisture_Retrieval_Data_1km/longitude_1km';
...
latlim=[floor(min(min(lat)))-1, ceil(max(max(lat)))+1];
lonlim=[floor(min(min(lon)))-1, ceil(max(max(lon)))+1];                                   
...
% units is pretty long so use a small font.
set (get(h, 'title'), 'string', units1, 'FontSize', 4, ...
                   'Interpreter', 'None', ...
                   'FontWeight','bold');
...
title({FILE_NAME; name}, ... 
      'Interpreter', 'None', 'FontSize', 7,'FontWeight','bold');
