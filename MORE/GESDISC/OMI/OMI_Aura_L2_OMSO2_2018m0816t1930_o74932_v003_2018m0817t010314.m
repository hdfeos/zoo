% 
%  This example code illustrates how to access and visualize OMI SO2 Swath file
% in MATLAB. 
%
...
% $matlab -nosplash -nodesktop -r OMI_Aura_L2_OMSO2_2018m0816t1930_o74932_v003_2018m0817t010314
%
...
% Open the HDF5 File.
FILE_NAME = ...
    'OMI-Aura_L2-OMSO2_2018m0816t1930-o74932_v003-2018m0817t010314.he5';
file_id = H5F.open (FILE_NAME, 'H5F_ACC_RDONLY', 'H5P_DEFAULT');

% Open the dataset.
DATAFIELD_NAME = '/HDFEOS/SWATHS/OMI Total Column Amount SO2/Data Fields/ColumnAmountSO2_PBL';
data_id = H5D.open (file_id, DATAFIELD_NAME);

Lat_NAME='HDFEOS/SWATHS/OMI Total Column Amount SO2/Geolocation Fields/Latitude';
lat_id=H5D.open(file_id, Lat_NAME);

Lon_NAME='HDFEOS/SWATHS/OMI Total Column Amount SO2/Geolocation Fields/Longitude';
