...
% 3B42 Grid files and calculate yearly average over some region in MATLAB.
%
...
%
%    $matlab -nosplash -nodesktop -r TRMM_3B42_Daily_y
%
...
D = dir(fullfile(thepath, '3B42_Daily.*.7.nc4'));
...
B = varfun(@mean, A, 'InputVariables', 2,...
           'GroupingVariables', 1);
% Draw plot.
f = figure('Name', '3B42 Yearly Average from 2018 to 2019', ...
           'visible', 'off');
...
s = '3B42_Daily Yearly Average [0~30N] & [20~60E]';
...
saveas(f, ['3B42_Daily.7.nc4.y.m.png']);
exit;
