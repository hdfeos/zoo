...
% TRMM 2A23 version 7 HDF4 files in MATLAB. 
%
...
%
% $matlab -nosplash -nodesktop -r TRMM_2A23_HDF_y
%
...
A2 = readtable('out_y2.csv');
B2 = varfun(@mean, A2, 'InputVariables', 2,...
           'GroupingVariables', 1);

% Draw plot.
f = figure('Name', '2A23 Yearly Average', ...
           'visible', 'off');
...
% Put title.
s = '2A23 Yearly Average in South Africa region';
