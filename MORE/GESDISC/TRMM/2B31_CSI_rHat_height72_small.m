...
figure('Name','2B31_CSI.990911.10296.KORA.6_rHat_height72')
...
colorbar('YTick', min_data:400:max_data);

plotm(coast.lat,coast.long,'k')

title({'2B31\_CSI.990911.10296.KORA.6\_rHat.hdf';'at height=72'},'FontSize',16,'FontWeight','bold');
