...
files and calculate yearly average over some region in Python.
...
for fn in sorted(glob.glob("3B42_Daily.*.7.nc4")):
    print(fn)
...
t = "{0}\n{1}\n{2}".format("3B42 Yearly Average", a[0], "with " + a[1])
...
# Save the plot.
pngfile = "3B42_Daily.7.nc4.y.py.png"
fig = plt.get_figure()
fig.savefig(pngfile)
