...
%
% $matlab -nosplash -nodesktop -r TRMM_2A23_2013_HDF_s
%
...
% Put title.
s = '2A23 2013 Seasonal Average in South Africa region';
...
xtickformat('%d');
xticks(B2.Var1);
xlabel({'Season in 2013' ; ['0=winter 1=spring 2=summer 3=fall']});
...
saveas(f, ['2A23_2013.HDF.s.m.png']);
exit;
