...
%Open the dataset
DATAFIELD1_NAME = '/HDFEOS/GRIDS/SET1/Data Fields/STv';
data1_id = H5D.open (file_id, DATAFIELD1_NAME);

DATAFIELD2_NAME = '/HDFEOS/GRIDS/SET2/Data Fields/STv';
...
figure('Name','GSSTFYC.2b.Year.1988_2008.he5 Yearly meridional wind stress')
...
title(['GSSTFYC.2b.Year.1988_2008 Yearly SET1 ', longname1', '   units: ',units1'],'FontSize',16,'FontWeight','bold');
...
title(['GSSTFYC.2b.Year.1988_2008 Yearly SET2 ', longname2', '   units: ',units2'],'FontSize',16,'FontWeight','bold');
