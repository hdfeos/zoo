...
%Open the dataset
DATAFIELD1_NAME = '/HDFEOS/GRIDS/SET1/Data Fields/H';
data1_id = H5D.open (file_id, DATAFIELD1_NAME);

DATAFIELD2_NAME = '/HDFEOS/GRIDS/SET2/Data Fields/H';
...
figure('Name','GSSTFYC.2b.Year.1988_2008.he5 Yearly sensible heat flux')
