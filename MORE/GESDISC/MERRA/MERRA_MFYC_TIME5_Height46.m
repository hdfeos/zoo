...
figure('Name','MERRA300.prod.assim.tavg3_3d_chm_Nv.20021201_MFYC_TIME5_Height46')
...
colorbar('YTick', min_data:2e9:max_data);

plotm(coast.lat,coast.long,'k')

title({'MERRA300.prod.assim.tavg3\_3d\_chm\_Nv.20021201\_MFYC.hdf';['at TIME=5 and Height=46, units: ',units]},'FontSize',16,'FontWeight','bold');
