...
figure('Name','MERRA300.prod.assim.inst3_3d_chm_Ne.20021201_PLE_TIME4_Height42')
...
colorbar('YTick', min_data:50:max_data);

plotm(coast.lat,coast.long,'k')

title({'MERRA300.prod.assim.inst3\_3d\_chm\_Ne.20021201\_PLE.hdf';['at TIME=4 and Height=42, units: ',units]},'FontSize',16,'FontWeight','bold');
