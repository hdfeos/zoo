...
%
% $matlab -nosplash -nodesktop -r CS_2B_GEOPROF_LIDAR
%
...
FILE_NAME = '2011077180414_26000_CS_2B-GEOPROF-LIDAR_GRANULE_P2_R04_E04.hdf';
...
% Plot all using pcolor() because contourf() is slow. 
...
title(tstring, 'Interpreter', 'none', 'FontSize', 10, 'FontWeight','bold');
