...
Usage:  save this script and run
    ...
    $python MOD10A1F.A2000229.h35v09.061.2020049131451.hdf.py
...
def run(FILE_NAME):
    ...
    m.drawmeridians(np.arange(min_lon, max_lon, 10), labels=[0, 0, 0, 1])    
...
if __name__ == "__main__":
    hdffile = 'MOD10A1F.A2000229.h35v09.061.2020049131451.hdf'
    run(hdffile)
