...
% For information on how to obtain the lat/lon data, check this URL http://hdfeos.org/zoo/note_non_geographic.php
  ...
  lat1D = load('lat_NpPolarGrid25km_AMSR_E_L3_SeaIce25km_V11_20050118.output');
  lon1D = load('lon_NpPolarGrid25km_AMSR_E_L3_SeaIce25km_V11_20050118.output');
...
% Read: http://nsidc.org/data/docs/daac/ae_si25_25km_seaice/data.html
  data = data * 0.1
...
% Plot the data using contourfm and axesm
  ...
  f=figure('Name','AMSR_E_L3_SeaIce25km_V11_20050118_SI_25km_NH_06V_ASC','visible','off')
  ...
  title({FILE_NAME; 'SI_25km_NH_06H_ASC'}, 'Interpreter', 'None', ...
  ...
  saveas(f,'AMSR_E_L3_SeaIce25km_V11_20050118_SI_25km_NH_06V_ASC.m.jpg');