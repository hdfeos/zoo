...
This example code illustrates how to access and visualize a NSIDC NISE 
...
Usage:  save this script and run
    ...
    $python NISE_SSMISF17_20110424.HDFEOS.py
...
def run(FILE_NAME):
    ...
    lamaz = '+proj=laea +a=6371228 +lat_0=90 +lon_0=0 +units=m'
    t = Transformer.from_crs(lamaz, "epsg:4326", always_xy=True)
    lon, lat = t.transform(xv, yv)

    # Basemap pcolormesh() doesn't allow inf value any more.
    pinf = float('+inf')
    lon[lon == pinf] = 0
    lat[lat == pinf] = 0
