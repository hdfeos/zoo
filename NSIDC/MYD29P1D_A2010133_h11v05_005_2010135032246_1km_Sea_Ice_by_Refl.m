...
% Read the Grid info using the hdfgd() interface.
...
% from HDFView MYD29P1D.A2010133.h11v05.005.2010135032246.hdf
...
% The following will return 5 data levels used in the dataset.
z = unique(data);
num_levels = size(z);
...
'MYD29P1D.A2010133.h11v05.005.2010135032246 1km Sea Ice by Reflectance', ...
'visible','off');


% Set the map parameters.
% We know that EASE Grid tile h11v05 lies in the Northern Hemisphere
...
colormap(cmap);
caxis([1 m]);
h = colorbar('YTickLabel', {'land', 'inland water', 'ocean', 'cloud','sea ice'}, 'YTick', y);
...
if ishghandle(figure_handle)
  ...
  'MYD29P1D.A2010133.h11v05.005.2010135032246_1km_SeaIce_Refl_matlab.jpg');
end
