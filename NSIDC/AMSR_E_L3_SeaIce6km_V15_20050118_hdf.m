...
%
%  $matlab -nosplash -nodesktop -r AMSR_E_L3_SeaIce6km_V15_20050118_hdf
%
...
latfile = fopen('psn06lats_v3.dat','r');
lonfile = fopen('psn06lons_v3.dat','r');

% Read the binary files as 4 byte integer to an array of 1792 x 1216.
l1 = fread(latfile, [1792 1216], 'int');
l2 = fread(lonfile, [1792 1216], 'int');
