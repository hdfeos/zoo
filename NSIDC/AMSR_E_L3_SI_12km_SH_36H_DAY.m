...
% For information on how to obtain the lat/lon data, check this URL http://hdfeos.org/zoo/note_non_geographic.php
  ...
  lat1D = load('lat_AMSR_E_L3_SeaIce12km_V11_20050118_SpPolarGrid12km.output');
  lon1D = load('lon_AMSR_E_L3_SeaIce12km_V11_20050118_SpPolarGrid12km.output');
...
% Plot the data using contourfm and axesm
  ...
  f=figure('Name','AMSR_E_L3_SeaIce12km_V11_20050118_SI_12km_SH_36H_DAY','visible','off')
  ...
  title({FILE_NAME; 'SI_12km_SH_36H_DAY'}, 'Interpreter', 'None', ...
  ...
  saveas(f,'AMSR_E_L3_SeaIce12km_V11_20050118_SI_12km_SH_36H_DAY.m.jpg');