...
%  CERES ES8 NOAA20 HDF4 Grid file in MATLAB. 
%
...
%
%  $matlab -nosplash -nodesktop -r CER_ES8_NOAA20_FM6_Edition1_101109_20220201_hdf
%
...
% Read lat.
sds_index = sd.nameToIndex(SD_id, 'Colatitude of CERES FOV at TOA');
sds_id = sd.select(SD_id, sds_index);
colat = sd.readData(sds_id);
sd.endAccess(sds_id);

% Read lon.
sds_index = sd.nameToIndex(SD_id, 'Longitude of CERES FOV at TOA');
sds_id = sd.select(SD_id, sds_index);
