...
%  CERES SSF NPP VIIRS HDF4 L3 Daily file in MATLAB. 
%
...
%
%  $matlab -nosplash -nodesktop -r CER_SSF1deg_Day_NPP_VIIRS_Edition2A_200203_201909_hdf
%
...
FILE_NAME='CER_SSF1deg-Day_NPP-VIIRS_Edition2A_200203.201909.hdf';
...
% Read day of month.
sds_index = sd.nameToIndex(SD_id, 'day_of_month');
sds_id = sd.select(SD_id, sds_index);
ind = sd.readData(sds_id);

% Get the long name from data field.
long_name_index = sd.findAttr(sds_id, 'long_name');
long_name_ind = sd.readAttr(sds_id, long_name_index);
...
% Put title. 
tstring = {FILE_NAME;[long_name, ' at ', long_name_ind, '=' num2str(ind(1))]};
