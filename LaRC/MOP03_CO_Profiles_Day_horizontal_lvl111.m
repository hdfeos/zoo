...
% Set title.
tstring = {FILE_NAME; [DATAFIELD_NAME ' at Latitude=' sprintf('%2.1f', lat(ydim)) ' degrees']};
...
saveas(f,['MOP03-20000303-' ...
          'L3V1.0.1_CO_Profiles_Day_horizontal_level111.m.jpg']);
