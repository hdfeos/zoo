...
data=squeeze(data1(:,:,151));
lat=squeeze(lat1(:,:,151));
lon=squeeze(lon1(:,:,151));
...
figure('Name','MISR_AM1_AGP_P001_F01_24_PtElev_SOMBlockDim150')
...
title({'MISR\_AM1\_AGP\_P001\_F01\_24\_PtElev' ; 'at SOMBlockDim=150'},'FontSize',16,'FontWeight','bold');
