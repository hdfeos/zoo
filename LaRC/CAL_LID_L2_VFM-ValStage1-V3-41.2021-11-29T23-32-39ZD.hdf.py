...
Usage:  save this script and run
    ...
    $python CAL_LID_L2_VFM-ValStage1-V3-41.2021-11-29T23-32-39ZD.hdf.py
...
def run(FILE_NAME):
    ...
    cb.ax.set_yticklabels(['invalid', 'clear', 'cloud', 'aerosol', 'strato',
                           'surface', 'subsurf', 'no signal'], fontsize=5)
...
if __name__ == "__main__":
    ...
    fname = 'CAL_LID_L2_VFM-ValStage1-V3-41.2021-11-29T23-32-39ZD.hdf'
    run(fname)
