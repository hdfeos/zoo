...
%  CERES SSF NOAA20 VIIRS HDF4 L3 Hourly file in MATLAB. 
%
...
%
%  $matlab -nosplash -nodesktop -r CER_SSF1deg_Hour_NOAA20_VIIRS_Edition1B_101102_20220131_hdf
%
...
% Read hour index.
sds_index = sd.nameToIndex(SD_id, 'gmt_hour_index');
sds_id = sd.select(SD_id, sds_index);
