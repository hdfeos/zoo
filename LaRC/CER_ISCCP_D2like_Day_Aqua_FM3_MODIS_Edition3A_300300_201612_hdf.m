...
%  CERS ISCCP D2like Day Aqua FM3 MODIS HDF4 file in MATLAB. 
%
...
%
%  $matlab -nosplash -nodesktop -r CER_ISCCP_D2like_Day_Aqua_FM3_MODIS_Edition3A_300300_201612_hdf
%
...
% Read lat.
sds_index = sd.nameToIndex(SD_id, 'Colatitude - Monthly Mean');
sds_id = sd.select(SD_id, sds_index);
...
% Read lon.
sds_index = sd.nameToIndex(SD_id, 'Longitude - Monthly Mean');
sds_id = sd.select(SD_id, sds_index);
