...
This example code illustrates how to access and visualize an LaRC 
MISR AM1 CGAL HDF-EOS2 Grid file in Python.
...
Usage:  save this script and run
    ...
    $python MISR_AM1_CGAL_2017_F06_0024.hdf.py
...
if __name__ == "__main__":
    ...
    hdffile = 'MISR_AM1_CGAL_2017_F06_0024.hdf'
    try:
