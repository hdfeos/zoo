...
% Read attribute for data field for data field name.
...
%  Set units to 'None' according to [1].
units = 'None';
...
saveas(f,'O19970011997031.L3m_MO_A520_9_l3m_data.m.jpg');
exit;
