...
%  SeaWiFS Grid HDF4 Grid file in MATLAB. 
%
...
fill_value_index = hdfsd('findattr', sds_id, 'Fill');
...
% Apply log for displaying image. See [1] for details.
data = log(data);
...
axesm('MapProjection','eqdcylin','Frame','on','Grid','on', ...
      ...
      'MeridianLabel','on','ParallelLabel','on', 'FontSize', 8)
