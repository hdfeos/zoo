...
This example code illustrates how to access and visualize an LP DAAC MYD13A1 v6
...
Usage:  save this script and run
    ...
    python MYD13A1.A2006329.h10v05.006.2015161182840.hdf.py
...
def run(FILE_NAME):
    ...
    if  USE_GDAL:    
        ...
        GEO_FILE_NAME = 'lat_MYD13A1.A2006329.h10v05.006.2015161182840.output'
        ...
        GEO_FILE_NAME = 'lon_MYD13A1.A2006329.h10v05.006.2015161182840.output'
...
if __name__ == "__main__":
    hdffile = 'MYD13A1.A2006329.h10v05.006.2015161182840.hdf'
    run(hdffile)
