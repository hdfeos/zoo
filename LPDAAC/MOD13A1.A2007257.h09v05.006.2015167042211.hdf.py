...
This example code illustrates how to access and visualize an LP DAAC MOD13A1 v6
...
Usage:  save this script and run
    ...
    python MOD13A1.A2007257.h09v05.006.2015167042211.hdf.py
...
def run(FILE_NAME):
    ...
    if  USE_GDAL:    
        ...
        GEO_FILE_NAME = 'lat_MOD13A1.A2007257.h09v05.006.2015167042211.output'
        ...
        GEO_FILE_NAME = 'lon_MOD13A1.A2007257.h09v05.006.2015167042211.output'
...
if __name__ == "__main__":
    hdffile = 'MOD13A1.A2007257.h09v05.006.2015167042211.hdf'
    run(hdffile)
