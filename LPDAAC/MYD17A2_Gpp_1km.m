...
lat1D = load('lat_MYD17A2.A2007073.h09v08.005.2007096132046.output');
lon1D = load('lon_MYD17A2.A2007073.h09v08.005.2007096132046.output');
...
f=figure('Name','MYD17A2.A2007073.h09v08.005.2007096132046_Gpp_1km','visible','off')
...
colorbar('YTick', min(min(data)):0.25:max(max(data)));
...
saveas(f,'MYD17A2.A2007073.h09v08.005.2007096132046_Gpp_1km_zoom.m.jpg');