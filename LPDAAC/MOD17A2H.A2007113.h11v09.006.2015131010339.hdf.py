...
This example code illustrates how to access and visualize an LP DAAC MOD17A2H v6
...
Usage:  save this script and run
    ...
    python MOD17A2H.A2007113.h11v09.006.2015131010339.hdf.py
...
def run(FILE_NAME):
    ...
    if  USE_GDAL:    
        ...
        # $eos2dump -c1 MOD17A2H.A2007113.h11v09.006.2015131010339.hdf > lat_MOD17A2H.A2007113.h11v09.006.2015131010339.output
        GEO_FILE_NAME = 'lat_MOD17A2H.A2007113.h11v09.006.2015131010339.output'
        ...
        # $eos2dump -c2 MOD17A2H.A2007113.h11v09.006.2015131010339.hdf > lon_MOD17A2H.A2007113.h11v09.006.2015131010339.output
        GEO_FILE_NAME = 'lon_MOD17A2H.A2007113.h11v09.006.2015131010339.output'
...
if __name__ == "__main__":
    hdffile = 'MOD17A2H.A2007113.h11v09.006.2015131010339.hdf'
    run(hdffile)
