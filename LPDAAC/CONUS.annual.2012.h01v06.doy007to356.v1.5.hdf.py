...
This example code illustrates how to access and visualize an LP DAAC MEaSURES
WELD CONUS yearly v1.5 Albers grid file in Python.
...
Usage:  save this script and run
    ...
    python CONUS.annual.2012.h01v06.doy007to356.v1.5.hdf.py
