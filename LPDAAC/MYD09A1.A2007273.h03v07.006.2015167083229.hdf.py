...
This example code illustrates how to access and visualize an LP DAAC MYD09A1 v6
...
Usage:  save this script and run
    ...
    python MYD09A1.A2007273.h03v07.006.2015167083229.hdf.py
...
def run(FILE_NAME):
    ...
    if  USE_GDAL:    
        ...
        # $eos2dump -c1 MYD09A1.A2007273.h03v07.006.2015167083229.hdf > lat_MYD09A1.A2007273.h03v07.006.2015167083229.output
        GEO_FILE_NAME = 'lat_MYD09A1.A2007273.h03v07.006.2015167083229.output'
        ...
        # $eos2dump -c2 MYD09A1.A2007273.h03v07.006.2015167083229.hdf > lon_MYD09A1.A2007273.h03v07.006.2015167083229.output
        GEO_FILE_NAME = 'lon_MYD09A1.A2007273.h03v07.006.2015167083229.output'
...
if __name__ == "__main__":
    hdffile = 'MYD09A1.A2007273.h03v07.006.2015167083229.hdf'
    run(hdffile)
