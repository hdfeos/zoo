%This example code illustrates how to access and visualize LP_DAAC_MOD Swath file in Matlab. 
...
FILE_NAME='MOD03.A2007278.0350.005.2009162161456.hdf';
...
f=figure('Name','MOD11_L2.A2007278.0350.005.2007280073443_LST')

axesm('MapProjection','eqdcylin','MapLatLimit', latlim, 'MapLonLimit',lonlim, 'Frame','on','Grid','on', ...
    'MeridianLabel','on','ParallelLabel','on','MLabelLocation',4,'PLabelLocation',2)
...
saveas(f,'MOD11_L2.A2007278.0350.005.2007280073443_LST_zoom.m.jpg');