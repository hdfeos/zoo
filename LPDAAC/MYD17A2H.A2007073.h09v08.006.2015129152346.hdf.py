...
This example code illustrates how to access and visualize an LP DAAC MYD17A2H v6
...
Usage:  save this script and run
    ...
    python MYD17A2H.A2007073.h09v08.006.2015129152346.hdf.py
...
def run(FILE_NAME):
    ...
    if  USE_GDAL:    
        ...
        GEO_FILE_NAME = 'lat_MYD17A2H.A2007073.h09v08.006.2015129152346.output'
        ...
        GEO_FILE_NAME = 'lon_MYD17A2H.A2007073.h09v08.006.2015129152346.output'
...
if __name__ == "__main__":
    hdffile = 'MYD17A2H.A2007073.h09v08.006.2015129152346.hdf'
    run(hdffile)
