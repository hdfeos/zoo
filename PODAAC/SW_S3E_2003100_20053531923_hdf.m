...
%
% $matlab -nosplash -nodesktop -r SW_S3E_2003100_20053531923_hdf
%
...
validrange_index = sd.findAttr(sds_id, 'valid_range');
validrange = sd.readAttr(sds_id, validrange_index);
