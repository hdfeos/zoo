...
% an NSIDC ICESat-2 ATL10 L3A version 6 HDF5 file in MATLAB. 
%
...
%                                   
% $matlab -nosplash -nodesktop -r ATL10_02_20181227215113_13790101_006_02_h5
%
...
% Open the datasets.
DATAFIELD_NAME = 'gt1r/freeboard_segment/beam_fb_height';
data_id = H5D.open(file_id, DATAFIELD_NAME);

LATFIELD_NAME='gt1r/freeboard_segment/geophysical/latitude';
lat_id=H5D.open(file_id, LATFIELD_NAME);

LONFIELD_NAME='gt1r/freeboard_segment/geophysical/longitude';
lon_id=H5D.open(file_id, LONFIELD_NAME);

TIMEFIELD_NAME='gt1r/freeboard_segment/geophysical/delta_time';
