...
ICESat-2 ATL11 L3B version 6 HDF5 file in Python.
...
Usage:  save this script and run
   ...
   $python ATL11_051911_0321_006_06.h5.py
...
with h5py.File(FILE_NAME, mode='r') as f:
    ...
    # Version 1 of ATL11 contains data from Cycle 3 through Cycle 7,
    # or five cycles. See [1] for the details.
