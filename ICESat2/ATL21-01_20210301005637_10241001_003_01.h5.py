...
NSIDC ICESat-2 ATL21 L3B HDF5 file in Python.
...
Usage:  save this script and run
   ...
   $python ATL21-01_20210301005637_10241001_003_01.h5.py
...
FILE_NAME = "ATL21-01_20210301005637_10241001_003_01.h5"
with h5py.File(FILE_NAME, mode="r") as f:
    ...
    dset_name = "/monthly/mean_weighted_mss"
    datavar = f[dset_name]
    data = datavar[:]
...
# Reference
# [1] https://nsidc.org/data/ATL21/versions/3
