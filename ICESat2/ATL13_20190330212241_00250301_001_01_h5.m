...
%  ICESat-2 ATL13 HDF5 file in MATLAB. 
%
...
%
%  $matlab -nosplash -nodesktop -r ATL13_20190330212241_00250301_001_01_h5
% 
%
...
% Open the HDF5 File.
FILE_NAME = 'ATL13_20190330212241_00250301_001_01.h5';
file_id = H5F.open (FILE_NAME, 'H5F_ACC_RDONLY', 'H5P_DEFAULT');

% Open the datasets.
LATFIELD_NAME='gt1l/segment_lat';
lat_id=H5D.open(file_id, LATFIELD_NAME);

LONFIELD_NAME='gt1l/segment_lon';
lon_id=H5D.open(file_id, LONFIELD_NAME);

DATAFIELD_NAME='gt1l/segment_geoid';
