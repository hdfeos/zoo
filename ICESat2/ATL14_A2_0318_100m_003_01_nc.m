...
% ATL14 version 3 HDF5 file in MATLAB. 
%
...
%                                   
% $matlab -nosplash -nodesktop -r ATL14_A2_0318_100m_003_01_nc
%
...
% Set the HDF5 File.
f = 'ATL14_A2_0318_100m_003_01.nc';

% Read the datasets.
ds = '/h';

% Subset the datasets since dataset is too big.
% Dataset is reduced to lat:227 * lon:267.
start = [1 1];
count = [267 227];
stride = [100 100];
...
x = h5read(f, '/x', 1, 267, 100);
y = h5read(f, '/y', 1, 227, 100);
