...
%  ICESat-2 ATL22 HDF5 file in MATLAB. 
%
...
%
%  $matlab -nosplash -nodesktop -r ATL22_20210712003905_02811201_002_01_h5
% 
%
...
% Open the datasets.
LATFIELD_NAME='gt1l/transect_lat';
lat_id=H5D.open(file_id, LATFIELD_NAME);

LONFIELD_NAME='gt1l/transect_lon';
lon_id=H5D.open(file_id, LONFIELD_NAME);

DATAFIELD_NAME='gt1l/inland_water_body_type';
