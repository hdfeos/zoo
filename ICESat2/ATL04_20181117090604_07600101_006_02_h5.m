...
%  NSIDC ICESat-2 ATL04 L2A version 6 HDF5 file in MATLAB. 
%
...
%
%  $matlab -nosplash -nodesktop -r ATL04_20181117090604_07600101_006_02_h5
%
...
% Open the datasets.
LATFIELD_NAME='profile_1/latitude';
lat_id=H5D.open(file_id, LATFIELD_NAME);

LONFIELD_NAME='profile_1/longitude';
lon_id=H5D.open(file_id, LONFIELD_NAME);

DATAFIELD_NAME='profile_1/dem_h';
